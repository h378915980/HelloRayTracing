...
// two code paths for building root signatures, this nv_helpers_dx12 method reconstructs a 1.0 signature when
...
//------------------------------------------------------------------------------------------------
// Pipeline State Stream nv_helpers_dx12s
//------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------
// Stream Parser nv_helpers_dx12s
...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_nv_helpers_dx12 : public ID3DX12PipelineParserCallbacks
{
    CD3DX12_PIPELINE_STATE_STREAM1 PipelineStream;
    CD3DX12_PIPELINE_STATE_STREAM_PARSE_nv_helpers_dx12()
        : SeenDSS(false)
    {
